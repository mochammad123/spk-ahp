                ...
                <div class="card-body">
                                    ...
                                    <ul class="list-inline m-0">
                                        <li class="list-inline-item">
                                            <div class="d-sm-flex align-items-center justify-content-beetwen">
                                                ...
                                                <a href="/dashboard/showsubcriteria/{{ $criteria->slug }}" class="btn btn-primary btn-icon-split btn-sm mb-2 open_modal">
                    ...
                    <div class="mb-3 d-flex justify-content-end">
                        <div class="col-xs-4">
                            ...
                            @foreach ($pvsubcriterias as $item)
                            ...
                            @if ($criteria_id == $criteria2_id)
                                <div class="alert alert-primary d-flex align-items-center" role="alert">
                                    ...
                                    <div style="margin-left: 10px">
                                    Silahkan melakukan perbandingan alternatif
                                    </div>
                                </div>
                            @else
                                <div class="alert alert-danger d-flex align-items-center" role="alert">
