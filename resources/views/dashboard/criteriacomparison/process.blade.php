                    ...
                    <div class="table-responsive">
                            <table class="table table-bordered datatab" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody> 
                                    ...
                                    @foreach ($rows as $criteria1 => $columns)
                                    <tr>
                                        @foreach ($criterias as $criteria)
                                        @if ($criteria->id == $criteria1)
                                        <td>{{ $criteria->criteria }}</td>
                                        @endif
                                        @endforeach  
                                        @foreach ($columns as $criteria2 => $grade)                                        
                                        <td>{{ $grade }}</td>
                                        @endforeach
                                    </tr>
                                    @endforeach
    ...
    <div class="col-xl-12 col-lg-12">
        <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <!-- Search Bar -->
                    <form action="/dashboard/criterias">
                        @if (request('decision'))
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered datatab" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody> 
                                ...
                                @foreach ($supportRows as $criteria1 => $columns)
                                <tr>
                                    @foreach ($criterias as $criteria)
                                    @if ($criteria->id == $criteria1)
                                    <td>{{ $criteria->criteria }}</td>
                            ...
                            <table class="table table-bordered datatab" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @endif
                                        @endforeach
                                        @foreach ($rank as $criteria2 => $grade)                                        
                                        <td>{{ number_format($grade, 2) }}</td>
                                        @endforeach
                                        <td>{{ $no++ }}</td>
                                    </tr>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered datatab" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody> 
                                ...
                                @foreach ($normalization as $criteria1 => $columns)
                                <tr>
                                    @foreach ($criterias as $criteria)
                                    @if ($criteria->id == $criteria1)
                                    <td>{{ $criteria->criteria }}</td>
                        ...
                        <form method="POST" action="/dashboard/priority" enctype="multipart/form-data">
                            @csrf
                            @foreach ($cl as $item)
                                <input type="text" style="font-size: 14px" class="form-control" id="criteria_id" name="criteria_id[]" required hidden value="{{ $item }}">
                            @endforeach
                            @foreach ($sp as $item)
                                <input type="text" style="font-size: 14px" class="form-control" id="score" name="score[]" required hidden value="{{ $item }}">
                            @endforeach
                        <div class="mb-3 d-flex justify-content-end">
                            <div class="col-xs-4">
